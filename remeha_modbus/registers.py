...
MAIN_CONTROLLER_REGISTERS = [
    ...
    RegisterDefinition(
        address=288, name="main_controller_burner_starts",
        description="Zähler Brennerstarts",
        data_type=DataType.UINT32, access=AccessMode.READ,
        register_count=2,
    ),
    RegisterDefinition(
        address=290, name="main_controller_burner_hours",
        description="Zähler Brennerstunden",
        data_type=DataType.UINT32, access=AccessMode.READ,
        register_count=2, unit="h",
    ),
    RegisterDefinition(
        address=292, name="main_controller_service_burning_hours",
...
APPLIANCE_REGISTERS = [
    ...
    RegisterDefinition(
        address=400, name="appliance_flow_temperature",
        description="Vorlauftemperatur",
        data_type=DataType.INT16, access=AccessMode.READ,
        gain=0.01, unit="°C",
    ),
    RegisterDefinition(
        address=401, name="appliance_return_temperature",
    ...
    RegisterDefinition(
        address=413, name="appliance_power_actual",
    ...
    RegisterDefinition(
        address=419, name="appliance_burner_starts",
        description="Zähler Brennerstarts",
        data_type=DataType.UINT32, access=AccessMode.READ,
        register_count=2,
    ),
    RegisterDefinition(
        address=421, name="appliance_burner_hours",
        description="Zähler Brennerstunden",
        data_type=DataType.UINT32, access=AccessMode.READ,
        register_count=2, unit="h",
    ),
...
MAINTENANCE_REGISTERS = [
    ...
    RegisterDefinition(
        address=514, name="maintenance_service_burning_hours",
